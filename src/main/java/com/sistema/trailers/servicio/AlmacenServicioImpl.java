...
public class AlmacenServicioImpl implements AlmacenServicio {
	...
	// esta notacion sirve para indicar que este metodo se va a ejecutar
	// cada vez que halla una nueva instancia de esta clase
	@PostConstruct
	@Override
	public void iniciarAlmacenDeArchivos() 
	{
		...
		{
			throw new AlmacenExcepcion("Errror al inicializar la ubicacion en el almacen de archivo");
		}
